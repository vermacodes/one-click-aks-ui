...
export default function TerminalContent({ autoScroll, updateLogs }: Props) {
	...
	return (
		<div
			className="h-screen max-h-screen overflow-y-auto bg-slate-900 p-4 text-sm text-slate-100 shadow-slate-300 scrollbar-thin scrollbar-thumb-slate-400 scrollbar-thumb-rounded dark:bg-[#020617] dark:scrollbar-thumb-slate-600 "
			ref={logContainerRef}
		>
