        ...
        <ol className="ml-6 list-decimal">
          <li className="py-1">
            ...
            <p className="mt-2 text-sm text-slate-500">
              You can run these steps on your system if you use linux (WSL) and have latest version of Azure CLI
          ...
          <li className="py-1">
            {" "}
            Copy subscription id from script's output, paste it in the input box below and click on Register button. If
            you run into issues{" "}
