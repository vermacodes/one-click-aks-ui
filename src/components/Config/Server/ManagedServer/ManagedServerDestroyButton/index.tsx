...
import { defaultUIErrorTextColor } from "../../../../../defaults";
    ...
    <>
      ...
      {confirmDestroy && (
        ...
        >
          ...
          <p className={`${defaultUIErrorTextColor} font-bold`}>
            IMPORTANT - Please Read 👇
          </p>
          <ul className="ml-4 list-disc space-y-2">
            <li className="text-sm">
              Server wont be deployed again automatically and you have to
              manually deploy it.
            </li>
            <li className="text-sm">
              Any deployments which are set to be auto-destroyed will not be
              destroyed until server is manually deployed again..
            </li>
          </ul>
        </ConfirmationModal>
      )}
