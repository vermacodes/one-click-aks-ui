...
export default function CustomDeployment({ serverHosting, setServerHosting }: Props) {
  ...
  return (
    <Container title="Custom Deployment" collapsible={true} hoverEffect={false} additionalClasses="border dark:border-slate-700 border-slate-300">
