...
const variantStyles: VariantStyles = {
  ...
  "secondary-outline":
    "ring-1 ring-slate-500 py-1 px-3 text-slate-500 disabled:ring-slate-400 disabled:text-slate-400 hover:ring-slate-700 hover:bg-slate-500  hover:text-slate-100 disabled:hover:ring-slate-400 disabled:hover:bg-inherit disabled:hover:text-slate-400 dark:disabled:ring-slate-700 dark:disabled:text-slate-500 ",
  "danger-outline":
