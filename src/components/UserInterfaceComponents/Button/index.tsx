...
// 	primary:
// 		"ring-1 ring-sky-700 bg-sky-700 py-1 px-3 text-white disabled:ring-slate-400 disabled:bg-slate-400 hover:ring-sky-700 hover:bg-sky-700 disabled:hover:ring-slate-400 disabled:hover:bg-slate-400 dark:disabled:ring-slate-700 dark:disabled:bg-slate-700 dark:disabled:text-slate-500",
// 	secondary:
...
// 	"secondary-outline":
// 		"ring-1 ring-slate-700 dark:ring-slate-400 py-1 px-3 text-slate-700 dark:text-slate-400 disabled:ring-slate-400 disabled:text-slate-400 hover:ring-slate-700 hover:bg-slate-700  hover:text-slate-100 disabled:hover:ring-slate-400 disabled:hover:bg-inherit disabled:hover:text-slate-400 dark:disabled:ring-slate-700 dark:disabled:text-slate-500 ",
// 	"danger-outline":
// 		"ring-1 ring-rose-700 dark:ring-rose-500 dark:text-rose-500 dark:hover:bg-rose-500 dark:hover:text-white py-1 px-3 text-rose-700 disabled:ring-slate-400 disabled:text-slate-400 hover:ring-rose-700 hover:bg-rose-700  hover:text-slate-100 disabled:hover:ring-slate-400 disabled:hover:bg-inherit disabled:hover:text-slate-400 dark:disabled:ring-slate-700 dark:disabled:text-slate-500 ",
// 	"success-outline":
