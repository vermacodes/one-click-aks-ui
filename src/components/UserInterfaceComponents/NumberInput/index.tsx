		...
		<div>
			<form className="flex items-center gap-2 text-nowrap">
				...
				<input
					...
					} ::-webkit-outer-spin-button]:m-0 rounded border-none bg-inherit px-2 py-1 outline-hidden ring-1 ring-slate-500 focus:ring-2 focus:ring-sky-500 [&::-webkit-inner-spin-button]:appearance-none`}
					{...rest}
				/>
			</form>
		</div>
