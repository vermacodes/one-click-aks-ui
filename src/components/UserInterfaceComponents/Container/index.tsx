...
export default function Container({
  ...
  return (
    <div
      ...
      ${
        hoverEffect &&
        "hover:shadow-lg hover:outline hover:outline-sky-700 dark:bg-slate-900 dark:outline-slate-600 dark:hover:outline-sky-500 "
      }{" "}
    ...
    >
      ...
      <div
        ...
        } ${!open ? "hidden max-h-0 overflow-hidden" : "max-h-fit"} `}
      >
        {children}
      </div>
    </div>
