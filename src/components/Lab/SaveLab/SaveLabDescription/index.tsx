...
import { FaBold, FaCode, FaFileCode, FaHeading, FaItalic, FaLink, FaListUl, FaUnlink } from "react-icons/fa";
...
export default function SaveLabDescription({ lab, setLab }: Props) {
	...
	const editor = useEditor({
		extensions: [
			...
			CodeBlock.configure({
				HTMLAttributes: {
					class: "p-2 my-2 bg-slate-300 rounded dark:bg-slate-600 w-full break-words whitespace-pre-wrap",
				},
			}),
		],
		...
		>
			<div className="flex flex-col space-y-2">
				<div className="flex space-x-1">
					...
					<Button
						variant={editor.isActive("bold") ? "secondary" : "secondary-outline"}
					...
					<Button
						variant={editor.isActive("italic") ? "secondary" : "secondary-outline"}
					...
					<Button
						variant={editor.isActive("code") ? "secondary" : "secondary-outline"}
					...
					<Button
						variant={editor.isActive("codeBlock") ? "secondary" : "secondary-outline"}
					...
					<Button
						variant={editor.isActive("bulletList") ? "secondary" : "secondary-outline"}
					...
					<Button
						onClick={setLink}
						variant={editor.isActive("link") ? "secondary" : "secondary-outline"}
						tooltipMessage="Link"
						tooltipDelay={200}
						tooltipDirection="top"
					>
