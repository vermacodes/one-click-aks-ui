	...
	useEffect(() => {
		const initialButtons: Record<string, ButtonContainerObj> = {
			...
			publishLabBUtton: {
				...
				order: 5,
				button: (
					<PublishLabButton key={"shareLabButton"} lab={lab} variant="secondary-text">
			...
			shareChallengeButton: {
				...
				order: 7,
				button: (
					<CopyLinkToLabButton key={"shareChallengeButton"} lab={lab} labType="challenge" variant="secondary-text">
						<span>
							<FaCopy />
						</span>
						Link to Challenge
